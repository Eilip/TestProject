...
class Quiz:
    ...
    def display_question(self):
        ...
        q_no = Label(root, text=question[self.q_no], width=60,
                     font=('Times New Roman', 20, 'bold'), anchor='w', bg="light green" )
    ...
    def display_title(self):
        ...
        title = Label(root, text="By Eilip karki",
                      width=58, bg="indigo", fg="white", font=("ariel", 20, "bold"))
    ...
    def radio_buttons(self):
        ...
        while len(q_list) < 4:
            ...
            radio_btn = Radiobutton(root, text=" ", variable=self.opt_selected,
                                    value=len(q_list) + 1, font=("Comic Sans MS", 14), bg="light green" )
...
lableimage.pack(pady=(0,40))


# get the data from the json file
with open('file 1.py') as f:
    data = json.load(f)
